...
if (XRegExp) {}(function (d) {
    ...
    RegExp.prototype.exec = function (u) {
        ...
        if (s) {
            if (!a && s.length > 1 && m(s, "") > -1) {
                ...
                l.replace.call((u + "").slice(s.index), q, function () {
    ...
    String.prototype.replace = function (s, t) {
        ...
        if (Object.prototype.toString.call(t) === "[object Function]") {
            q = l.replace.call(this + "", s, function () {
                if (r) {
            ...
            v = this + "";
            q = l.replace.call(v, s, function () {
                var w = arguments;
                return l.replace.call(t + "", c, function (y, x, B) {
                    if (x) {
                        switch (x) {
                            case "$":
                                return "$";
